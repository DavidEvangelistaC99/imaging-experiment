...
figpath = '/home/david/Documents/faraday-experiment/results/FaradayDP/Faraday_2025_01/' # '/media/cportilla/HDD/Faraday/2025_01/TESTTTT/'
figpath_server=figpath
data_path = '/mnt/compartido/main_radar/rawdata' # '/home/cportilla/Minotaur/2025_01/Drifts_Faraday/main_radar/rawdata/'
...
proc_spectra.addParameter(name='nFFTPoints', value='24')
proc_spectra.addParameter(name='nProfiles', value='24')
...
op19.addParameter(name='save', value=figpath)
#'''

op08 = proc_spectra.addOperation(name='IntegrationFaradaySpectra')
op08.addParameter(name='n', value='50')
...
op9.addParameter(name='zmin', value=db_range[0])
op9.addParameter(name='zmax', value=db_range[1])
#op9.addParameter(name='ymin', value='0')
#op9.addParameter(name='ymax', value='320')
...
op11 = proc_spectra.addOperation(name='CleanCohEchoes')
...
op185 = proc_spectra.addOperation(name='DenCorrection')
...
# f=open('/media/cportilla/HDD/Clean_Data/moder_test.txt','r')
