...
dpath = '/mnt/hydra/main_radar/rawdata'

# dpath = '/mnt/compartido4/imaging'
# pptah -> processed data
ppath = '/home/david/Documents/DATA-2/Imaging/14_Aug_26/hydra-pdata-6'
plots = ppath
mpath = ppath
delay = 30
walk=1
...
# El numero de nFFTPoints debe ser igual a nProfiles influye en la calibracion por el zero-padding
...
opObj11.addParameter(name='id', value='27')
opObj11.addParameter(name='wintitle', value='Noise')
opObj11.addParameter(name='xmin', value=11.75)
opObj11.addParameter(name='xmax', value=12.25)
opObj11.addParameter(name='save', value=plots)
...
op9.addParameter(name='xmin', value=11.75)
op9.addParameter(name='xmax', value=12.25)
...
opObj11.addParameter(name='xmin', value=11.75, format='float')
