...
endDate =  '2025/09/23'
startTime =  '09:07:00' # 09 07 00
endTime =  '09:30:00'

dpath = '/mnt/minotauro/2025_09/150kM-Hydra/main_radar/rawdata'
ppath = '/mnt/data10tb/christianP_proc/150km_Imaging'
plots = ppath
mpath = ppath
delay = 30
walk=1
...
opObj11.addParameter(name='n', value='100', format='float')
